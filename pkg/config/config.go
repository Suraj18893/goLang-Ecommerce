...
type Config struct {
	...
	PORT       string `mapstructure:"PORT"` // Add this field
}

var envs = []string{
    "DB_HOST", "DB_NAME", "DB_USER", "DB_PASSWORD", "DB_PORT", "DB_ACCOUNTSID", "DB_SERVICEID", "DB_AUTHTOKEN", "DB_UNIDOC_LICENSE_API_KEY", "PORT", // Add PORT here
}
